...
def upload_parquet_from_bytes(parquet_buffer: BytesIO, object_name_p: str, bucket_name_p: str = "curated") -> None:
    """
    Uploads a parquet from a BytesIO to a Minio bucket.

    Args:
        parquet_buffer (BytesIO): The parquet data to be uploaded.
        object_name_p (str): The name of the object in the bucket.
        bucket_name_p (str, optional): The name of the bucket. Defaults to "curated".
...
def get_object_list(path: str, date_filter: str, bucket_name: str = "raw") -> list:
    """
...
def get_object_content(object_name: str, bucket_name: str = "raw") -> str:
    """
    Retrieves the content of an object from a Minio bucket.

    Args:
        object_name (str): The name of the object to retrieve.
        bucket_name (str, optional): The name of the bucket. Defaults to "raw".
